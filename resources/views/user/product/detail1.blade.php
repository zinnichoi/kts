    ...
    <div id="wrapper" class="width-float ">
        ...
        <div class="singleProjectWrap clear">
            <div class="singleProjectGallery">
                ...
                <div class="owl-gallery-wrap">
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product1/detail1.JPG') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product1/detail2.JPG') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product1/detail3.JPG') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product1/detail4.JPG') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product1/detail5.JPG') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product1/detail6.JPG') }}"
                             class="img-responsive" alt="">
                    </div>
            ...
            <div class="singleProjectDesc">
                <h1>Thiết kế nội thất cao cấp chung cư Sky Lake nhà anh Đức</h1>
                ...
                <div class="singleProjectDescText jspScrollable" tabindex="0">
                    <p>
                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Dự án: Thiết kế nội thất chung cư phong cách hiện đại</span></span>
                    </p>

                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Chủ đầu tư: Anh Đức</span></span>
                    </p>

                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Chung cư Sky Lake</span></span>
                    </p>
