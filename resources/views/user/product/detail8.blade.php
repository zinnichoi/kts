        ...
        <div class="singleProjectWrap clear">
            <div class="singleProjectGallery">
                ...
                <div class="owl-gallery-wrap">
                    ...
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product8/detail2.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product8/detail3.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product8/detail4.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product8/detail5.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product8/detail6.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product8/detail7.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product8/detail8.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                </div>
            ...
            <div class="singleProjectDesc">
                <h1>Thiết kế nội thất cao cấp chung cư FLC2 anh Đương</h1>
                ...
                <div class="singleProjectDescText jspScrollable" tabindex="0">
                    <p>
                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Dự án: Thiết kế nội thất cao cấp chung cư FLC2 Bay anh Đương</span></span>
                    </p>

                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Chủ đầu tư: anh Đương</span></span>
                    </p>

                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Chung cư FLC2</span></span>
                    </p>
