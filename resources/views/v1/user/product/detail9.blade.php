        ...
        <div class="singleProjectWrap clear">
            <div class="singleProjectGallery">
                ...
                <div class="owl-gallery-wrap">
                    ...
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product9/detail2.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product9/detail3.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product9/detail4.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product9/detail5.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product9/detail6.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product9/detail7.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product9/detail8.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product9/detail9.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product9/detail10.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product9/detail11.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                </div>
            ...
            <div class="singleProjectDesc">
                <h1>Thiết kế nội thất cao cấp chung cư anh Đức Hào Nam</h1>
                ...
                <div class="singleProjectDescText jspScrollable" tabindex="0">
                    <p>
                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Dự án: Thiết kế nội thất cao cấp chung cư anh Đức Hào Nam</span></span>
                    </p>

                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Chủ đầu tư: anh Đức</span></span>
                    </p>

                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Hào Nam</span></span>
                    </p>
