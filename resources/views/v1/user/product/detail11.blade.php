        ...
        <div class="singleProjectWrap clear">
            <div class="singleProjectGallery">
                ...
                <div class="owl-gallery-wrap">
                    ...
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product11/detail2.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product11/detail3.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product11/detail4.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product11/detail5.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                </div>
            ...
            <div class="singleProjectDesc">
                <h1>Thiết kế quán cafe Văn Quán</h1>
                ...
                <div class="singleProjectDescText jspScrollable" tabindex="0">
                    <p>
                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Dự án: Thiết kế quán cafe Văn Quán</span></span>
                    </p>

                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Chủ đầu tư: chị Linh</span></span>
                    </p>
                    ...
                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Không ngừng phát triển để mang đến nhiều phong cách và tối ưu không gian với những dự án nhỏ hẹp, tối ưu công năng triệt để. Ý tưởng được sự kết hợp giữ không gian xanh và quầy trưng bày thoáng đãng&nbsp;<span
