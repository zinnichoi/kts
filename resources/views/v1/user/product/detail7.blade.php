        ...
        <div class="singleProjectWrap clear">
            <div class="singleProjectGallery">
                ...
                <div class="owl-gallery-wrap">
                    ...
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product7/detail2.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product7/detail3.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product7/detail4.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product7/detail5.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product7/detail6.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product7/detail7.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product7/detail8.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product7/detail9.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product7/detail10.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product7/detail11.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product7/detail12.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                    <div class="item-img-gallery">
                        <img src="{{ asset('assets/image/product/product7/detail13.jpg') }}"
                             class="img-responsive" alt="">
                    </div>
                ...
                <div class="cover-thumbs">
                    <div class="cover-thumbs-2">
                        <div class="owl-gallery-thumb">
                            ...
                            <div class="item-img-thumb " data-pos="6">
                                <img src="{{ asset('assets/image/product/product7/detail6.jpg') }}"
                                     class="img-responsive" alt="">
                            </div>
                            <div class="item-img-thumb " data-pos="7">
                                <img src="{{ asset('assets/image/product/product7/detail7.jpg') }}"
                                     class="img-responsive" alt="">
                            </div>
                            <div class="item-img-thumb " data-pos="8">
                                <img src="{{ asset('assets/image/product/product7/detail8.jpg') }}"
                                     class="img-responsive" alt="">
                            </div>
                            <div class="item-img-thumb " data-pos="9">
                                <img src="{{ asset('assets/image/product/product7/detail9.jpg') }}"
                                     class="img-responsive" alt="">
                            </div>
                            <div class="item-img-thumb " data-pos="10">
                                <img src="{{ asset('assets/image/product/product7/detail10.jpg') }}"
                                     class="img-responsive" alt="">
                            </div>
                            <div class="item-img-thumb " data-pos="11">
                                <img src="{{ asset('assets/image/product/product7/detail11.jpg') }}"
                                     class="img-responsive" alt="">
                            </div>
                            <div class="item-img-thumb " data-pos="12">
                                <img src="{{ asset('assets/image/product/product7/detail12.jpg') }}"
                                     class="img-responsive" alt="">
                            </div>
                            <div class="item-img-thumb " data-pos="13">
                                <img src="{{ asset('assets/image/product/product7/detail13.jpg') }}"
                                     class="img-responsive" alt="">
                            </div>
                        </div>
            ...
            <div class="singleProjectDesc">
                <h1>Thiết kế nội thất cao cấp chung cư Green Bay anh Phong</h1>
                ...
                <div class="singleProjectDescText jspScrollable" tabindex="0">
                    <p>
                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Dự án: Thiết kế nội thất cao cấp chung cư Green Bay anh Phong</span></span>
                    </p>

                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Chủ đầu tư: anh Phong</span></span>
                    </p>

                    <p><span style="font-size:16px;"><span style="font-family:Times New Roman,Times,serif;">Chung cư Green Bay</span></span>
                    </p>
